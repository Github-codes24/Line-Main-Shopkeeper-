    ...
    return (
        <div className="flex bg-[#E0E9E9] font-medium min-h-screen">
            <main className="flex-1 p-3 gap-2">
                ...
                <div className="bg-white shadow-xl flex flex-col gap-3 mb-4 relative rounded-lg p-3 min-h-screen">
                    {/* Filter bar */}
                    ...
                    {/* Pagination */}
                    <div className="w-full flex flex-col md:flex-row justify-between items-center gap-2 p-2 text-sm font-semibold text-black bg-gray-200 rounded-md">
                        <span>
