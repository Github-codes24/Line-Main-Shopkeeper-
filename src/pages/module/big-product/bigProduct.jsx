    ...
    return (
        <div className="flex bg-[#E0E9E9] font-medium ">
            ...
            <main className="flex-1 p-3  gap-2">
                ...
                {/* Search and Filter */}
                <div className="bg-white shadow-xl flex flex-col gap-3 mb-4 relative rounded-md p-4 min-h-screen">
                    {/* Filter bar */}
                    ...
                    <div className="sm:hidden flex flex-col gap-3">
                        {products.map((product, index) => (
                            <div key={product.id} className="border rounded-lg shadow-md p-3 flex flex-col gap-2">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className={`text-xs mt-1 font-semibold ${getStatusColor(product.status)}`}>
                                            {product.status}
                                        </p>
                                    </div>
                                </div>
                    ...
                    {/* ✅ Pagination */}
                    <div className="w-full flex flex-col md:flex-row justify-between items-center gap-3 p-2 text-sm font-semibold text-black bg-gray-200 rounded-md">
                        <span>Showing 1 to 5 of {products.length} Entries</span>
                        <div className="flex items-center gap-2">
                            <button className="px-2 py-1 text-teal-700 hover:bg-purple-100 rounded">&lt;</button>
