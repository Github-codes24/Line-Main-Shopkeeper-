            ...
            try {
                ...
                if (result && result.success) {
                    ...
                    const formattedData = {
                        ...
                        customerName: paymentData.worker?.name || 'N/A',
                        phoneNumber: paymentData.worker?.contact || 'N/A',
                        address: "Address not available in API",
                        email: paymentData.shopKeeper?.contact || 'N/A',
                        orderStatus: paymentData.status === 'created' ? 'In Progress' : 'Settled',
                        service: paymentData.worker?.experties || 'N/A',
            ...
            <main className="flex-1 p-3 gap-2">
                ...
                <div className="bg-white rounded-lg shadow-md p-6 mx-auto">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-start gap-3">
                            <span className="w-40 text-left font-medium text-gray-700">product List  :</span>
                            <div className="flex gap-2 items-center">
                                {data.images.map((img, index) => (
                                    <img key={index} src={img} alt={`img-${index}`} className="w-20 h-16 rounded-md border border-gray-300 object-cover" />
                                ))}
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center gap-3">
                            <span className="w-40 text-left font-medium text-gray-700">Amount Status  :</span>
                            <input type="text" value={data.service} disabled className="flex-1 px-4 py-1 border border-teal-600 rounded-md bg-gray-100 font-medium" />
                        </div>
                    </div>
                    ...
                    <div className="flex justify-center mt-8">
                        <button
                            ...
                            className="px-6 py-2 bg-teal-700 text-white rounded-md  transition disabled:bg-gray-400 disabled:cursor-not-allowed"
                        >
