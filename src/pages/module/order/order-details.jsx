            ...
            <div className="bg-white shadow-sm rounded-lg p-3 mt-3 flex flex-col h-[100vh]">
                <div className="border-1 border-[#999999] rounded-md px-14 py-6 space-y-6 overflow-y-auto flex-1 scrollbar-hide">
                    ...
                    <div>
                        ...
                        <input
                            className="border-1 font-extrabold border-[#007E74] bg-[#E0E9E9] px-3 py-1 rounded-md ml-2"
                            readOnly
                    ...
                    <div>
                        ...
                        <div className="mt-2 space-y-4">
                            ...
                            <div className="flex items-center space-x-2">
                                <label className="font-medium w-40">Order Status</label>
                                <span className="font-medium">:</span>
                                <input
                                    className="border-1 border-[#007E74] bg-[#E0E9E9] text-[#FFCC00] px-4 py-1 rounded-lg w-80"
                                    readOnly
                                    value="Pending"
                                />
                            </div>
                    ...
                    <div>
                        ...
                        <div className="mt-2 space-y-4">
                            ...
                            <div className="flex items-start">
                                ...
                                <span className="font-medium pl-4">:</span>
                                <img
                                    src={ServiceImg} // Replace with actual image
                                    alt="service"
                            ...
                            <div className="flex flex-col">
                                <h2 className="text-base font-medium mb-4">Product List <span className="font-medium pl-20">:</span></h2>
                ...
                <div className="flex justify-center space-x-5 mt-6">
                    <button className="px-10 py-2 border-1 bg-[#D9F1EB] border-[#007E74] font-medium text-[#007E74] rounded-lg">
                        Reject Order
                    </button>
...
const LabelInput = ({ label, value }) => (
    <div className="flex items-center">
        ...
        <input
            type="text"
            className="border-1 ml-2 border-[#007E74] bg-[#E0E9E9] px-3 py-1 rounded-lg w-80"
            readOnly
            value={value}
        />
    </div>
