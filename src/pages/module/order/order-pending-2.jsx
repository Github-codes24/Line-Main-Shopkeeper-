...
// OrderDeatils
const OrderPending2 = ({ showButtons = true, customButtons = null, orderStatus = "Pending", orderStatusColor = "#FFCC00", customAdditionalDetails = null }) => {
                    ...
                    <div>
                        ...
                        <div className="mt-2 space-y-4">
                            ...
                            <div className="flex items-center space-x-2">
                                ...
                                <span className="font-medium px-2">:</span>
                                <input
                                    className="border-1 border-[#007E74] bg-[#E0E9E9] text-[#EC2D01] px-3 py-1 rounded-lg w-80"
                                    readOnly
                                    value="Rejected"
                                />
                            </div>
